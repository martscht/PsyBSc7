...
# Begin grading:
res1 <- summary(lm.beta(mod))

grade_result(
  fail_if(~ (!identical(.result, res1)), 'Haben Sie die richtigen Input-Argumente verwendet? Sie wollen die summary des standardisierten Modells ausgeben. Schauen Sie sich ggf. die Hints an.'),
