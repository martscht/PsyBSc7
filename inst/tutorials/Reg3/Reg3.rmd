...
```{r exercise_avPlots, exercise = TRUE, exercise.eval = FALSE, setup = exercise_setup1}
avPlots(..., pch = 16, lwd = 4)
```
...
```{r exercise_residualPlots, exercise = TRUE, exercise.eval = FALSE, setup = exercise_setup1}
# Grafisch (+ Test auf Nicht-Linearität)
residualPlots(..., pch = 16)
```
...
```{r exercise_ncvTest, exercise = TRUE, exercise.eval = FALSE, setup = exercise_setup1}
# Test For Non-Constant Error Variance
ncvTest(...)
```

```{r exercise_ncvTest-solution, exercise = TRUE, exercise.eval = FALSE, setup = exercise_setup1}
# Test For Non-Constant Error Variance
ncvTest(mod)
```
