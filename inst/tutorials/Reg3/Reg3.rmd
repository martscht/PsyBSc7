...
*Fall 2*: $X'X=\begin{pmatrix}100&0&0\\0&100&97\\0&97&100\end{pmatrix} \qquad$  und 
...
*Fall 2*: $\Sigma_2=\begin{pmatrix}1&0&0\\0&1&.97\\0&.97&1\end{pmatrix} \qquad$  und 
...
```
Die Standardfehler des *Fall 2* sind sehr groß im Vergleich zu *Fall 1*. Die Determinante von $X'X$ in *Fall 2* liegt nahe $0$; im *Fall 1* bei $1000000$.
```{r}
