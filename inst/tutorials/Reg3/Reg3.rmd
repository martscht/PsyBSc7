...
Wir übergeben wieder das Regressionsmodell an `vif`.
...
```{r exercise_CD, exercise = TRUE, exercise.eval = FALSE, exercise.setup = "exercise_setup2"}
# Cooks Distanz
...
```{r exercise_Blasen, exercise = TRUE, exercise.eval = FALSE, exercise.setup = "exercise_setup2"}
