...
Wenn Sie eine Auffrischung der Inhalte des letzten Semesters benötigen oder sich gerne nochmal auf die Datenanalyse in R einstimmen möchten, sehen Sie gerne unter dem folgenden Link den Inhalt der Einführungssitzung des letzten Semesters an: https://pandar.netlify.com/post/r-crash-kurs/
...
Objekte können unter anderem für einfache Rechenoperationen (`+`, `-`, `*`, `/`, `^`) sowie für logische Abfragen (`==`, `!=`, `>`, `>=`, `<`, `<=`) genutzt werden. Weiterführende Informationen und Übersicht zu Rechenoperationen und logischen Abfragen finden Sie beispielsweise unter https://www.statmethods.net/management/operators.html.
