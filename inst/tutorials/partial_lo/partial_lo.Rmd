---
title: "Partial- und Semipartialkorrelationen"
# author: "Luisa Grützmacher"
# date: "4/27/2020"
output:
...
*Statistik für Psychologen: PraktikumPsyBSc 7,Sommersemester 2020*

# Beispiel Geschlechtsunterschiede in der Lesekompetenz

```{r data}
# Datensatz laden
data(PISA_2009, package = 'PsyBSc7')
library(ppcor)
```
...
# t-Test
t.test(PISA_2009$Reading ~ PISA_2009$Female)

# Regression
reg <- lm(Reading ~ Female, data = PISA_2009)
summary(reg)

# Korrelation
cor.test(PISA_2009$Female, PISA_2009$Reading)
...
cor.test(PISA_2009$Reading, PISA_2009$LearnMins)

#2b Korrelation Lesekompetenz - Freude am Lesen
cor.test(PISA_2009$Reading, PISA_2009$JoyRead)

#2c Korrelation Geschlecht - Lernzeit
cor.test(PISA_2009$Female, PISA_2009$LearnMins)

#2d Korrelation Geschlecht - Freude am Lesen
cor.test(PISA_2009$Female, PISA_2009$JoyRead)
```
...
pcor.test(x=PISA_2009$Reading, y=PISA_2009$Female, z=PISA_2009$LearnMins)
# 3b Partialkorrelationen zwischen Geschlecht und Lesekompetenz unter Kontrolle der Lesefreude
pcor.test(x=PISA_2009$Reading, y=PISA_2009$Female, z=PISA_2009$JoyRead)
...
spcor.test(x=PISA_2009$Female, y=PISA_2009$Reading, z=PISA_2009$LearnMins)
...
spcor.test(x=PISA_2009$Female, y=PISA_2009$Reading, z=PISA_2009$JoyRead)
...
pcor.test(PISA_2009$Reading, PISA_2009$Female, PISA_2009[,c ("LearnMins", "JoyRead")])
