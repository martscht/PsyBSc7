...
```{r test_anova_pop,  exercise = TRUE, exercise.eval = FALSE, setup="exercise_setup2"}
...
Auch dem `geom_smooth` Befehl kann einfach das modifizierte Regressionsmodell übergeben werden. Stellen Sie die Weltbevölkerung sowie das lineare und das quadratische Modell dar.
```{r exercise_graph_pop,  exercise = TRUE, exercise.eval = FALSE, fig.height=6, fig.align="center"}
ggplot(data = WorldPopulation, aes(x = Year, y = Population))+
